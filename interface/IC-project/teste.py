...
sample_path = './public/sample/sample.csv' #sys.argv[1]
...
predicted_probabilities = pipeline.named_steps['mlp'].predict_proba(sample_transformed[0].reshape(1, -1))
